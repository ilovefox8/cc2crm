...
class InboundEmail extends \Fox\Services\Record
{
    ...
    {
        $roundRobin = new \Fox\Modules\Crm\Business\CaseDistribution\RoundRobin($this->getEntityManager());
    ...
    {
        $leastBusy = new \Fox\Modules\Crm\Business\CaseDistribution\LeastBusy($this->getEntityManager());
