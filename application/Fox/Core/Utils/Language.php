...
class Language
{
    ...
    public function __construct(\Fox\Core\Utils\File\Manager $fileManager, \Fox\Core\Utils\Config $config, \Fox\Entities\Preferences $preferences = null)
    {
        $this->fileManager = $fileManager;
        $this->config = $config;
        $this->preferences = $preferences;

        $this->unifier = new \Fox\Core\Utils\File\Unifier($this->fileManager);
    }
